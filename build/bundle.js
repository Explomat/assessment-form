...
module.exports = function (user) {
	return (
		"<button onclick=window.forms.savePdf(event) class='inputButton'>Сохранить в .PDF</button>\n\
		 ...
		 <button onclick=window.forms.print(event) class='inputButton'>Печать</button>"
	);
}
